    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-dark-card border border-dark-border p-6 rounded-sm">
          <p className="text-sm font-bold text-cream/40 uppercase tracking-widest mb-1">30D Revenue</p>
          <p className="text-sm font-display font-bold text-gold-500">Rs. {totalRevenue.toLocaleString()}</p>
        </div>
        <div className="bg-dark-card border border-dark-border p-6 rounded-sm">
          <p className="text-sm font-bold text-cream/40 uppercase tracking-widest mb-1">Total Orders</p>
          <p className="text-sm font-display font-bold text-cream">{initialOrders.length}</p>
        </div>
        <div className="bg-dark-card border border-dark-border p-6 rounded-sm">
          <p className="text-sm font-bold text-cream/40 uppercase tracking-widest mb-1">Avg Order Value</p>
          <p className="text-sm font-display font-bold text-cream">Rs. {Math.round(avgOrderValue)}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-dark-card border border-dark-border p-8 rounded-sm">
          <h3 className="text-sm font-display font-bold text-cream mb-6">Revenue Trend</h3>
        ...
        {/* Hourly Heatmap */}
        <div className="bg-dark-card border border-dark-border p-8 rounded-sm">
          <h3 className="text-sm font-display font-bold text-cream mb-6">Peak Ordering Hours</h3>
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
