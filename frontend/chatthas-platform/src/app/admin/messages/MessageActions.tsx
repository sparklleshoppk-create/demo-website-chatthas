    ...
    <div className="flex gap-2">
      {status === 'unread' && (
        <button 
          ...
          className="px-3 py-1 bg-gold-500/10 text-gold-500 text-sm font-bold uppercase tracking-widest border border-gold-500/20 rounded-sm hover:bg-gold-500 hover:text-charcoal transition-all"
        >
          Mark as Read
        </button>
      )}
