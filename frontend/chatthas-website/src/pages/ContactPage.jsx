    ...
    <div className="bg-charcoal min-h-screen text-cream pb-20 pt-24">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            <h2 className="text-3xl font-display font-bold text-white mb-8">Reach Out Directly</h2>
            ...
            <h2 className="text-3xl font-display font-bold text-white mb-8">Our Locations</h2>
