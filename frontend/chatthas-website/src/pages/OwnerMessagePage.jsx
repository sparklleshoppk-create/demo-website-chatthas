    ...
    <div className="bg-charcoal min-h-screen text-cream pb-20 pt-24">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-6">Waqar Chattha</h1>
            <h2 className="text-2xl text-gold-500 font-display italic mb-8">"Making Desi Food Great Again"</h2>
      ...
      <section className="py-24 bg-dark-card/20 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          >
            <p className="text-2xl text-white font-display leading-relaxed text-center">
            ...
            <div className="mt-16 pt-8 border-t border-white/10 text-center">
              ...
              <p className="font-display text-xl text-white">Waqar Chattha</p>
