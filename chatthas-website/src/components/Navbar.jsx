        ...
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 text-xs font-semibold tracking-widest uppercase text-charcoal rounded-sm transition-all duration-300 hover:shadow-gold"
        ...
        {mobileOpen && (
          ...
          >
            ...
            <div className="flex gap-4 mt-6">
              <Link to="/order" className="btn-gold flex-1 justify-center text-center text-xs">Order Online</Link>
              <Link to="/franchise" className="btn-outline-gold flex-1 justify-center text-center text-xs">Franchise</Link>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
